...
var eventemitter2_1 = tslib_1.__importDefault(require("eventemitter2"));
/**
...
createjs.Stage.prototype.globalToRos = function (x, y) {
    ...
    return new roslib_1["default"].Vector3({
        x: rosX,
        y: rosY
    });
};
...
ROS2D.ImageMap = function (options) {
    ...
    this.pose = new roslib_1["default"].Pose({
...
ROS2D.ImageMapClient = function (options) {
    ...
    var rosTopic = new roslib_1["default"].Topic({
        ros: ros,
        name: topic,
...
ROS2D.ImageMapClient.prototype.__proto__ = eventemitter2_1["default"].prototype;
/**
 * @author Russell Toris - rctoris@wpi.edu
 */
/**
...
ROS2D.OccupancyGridClient.prototype.__proto__ = eventemitter2_1["default"].prototype;
/**
...
ROS2D.OccupancyGridSrvClient = function (options) {
    ...
    var rosService = new roslib_1["default"].Service({
        ros: ros,
        name: service,
        serviceType: 'nav_msgs/GetMap',
        compression: 'png'
    });
    rosService.callService(new roslib_1["default"].ServiceRequest(), function (response) {
        // check for an old map
        if (that.currentGrid) {
            that.rootObject.removeChild(that.currentGrid);
        }
...
ROS2D.OccupancyGridSrvClient.prototype.__proto__ = eventemitter2_1["default"].prototype;
/**
...
ROS2D.PolygonMarker.prototype.splitLine = function (obj) {
    ...
    var xh = (xs + xe) / 2.0;
    var yh = (ys + ye) / 2.0;
    var pos = new roslib_1["default"].Vector3({ x: xh, y: -yh });
...
ROS2D.PanView = function (options) {
    ...
    this.startPos = new roslib_1["default"].Vector3();
};
...
ROS2D.ZoomView = function (options) {
    ...
    this.center = new roslib_1["default"].Vector3();
    this.startShift = new roslib_1["default"].Vector3();
    this.startScale = new roslib_1["default"].Vector3();
};
