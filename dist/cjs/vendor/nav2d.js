...
var ros2d_1 = tslib_1.__importDefault(require("./ros2d"));
...
NAV2D.ImageMapClientNav = function (options) {
    ...
    var client = new ros2d_1["default"].ImageMapClient({
        ros: this.ros,
...
NAV2D.Navigator = function (options) {
    ...
    function sendGoal(pose) {
        ...
        var goalMarker = new ros2d_1["default"].NavigationArrow({
            size: 15,
            strokeSize: 1,
    ...
    var robotMarker = new ros2d_1["default"].NavigationArrow({
        size: 25,
        strokeSize: 1,
    ...
    var poseListener = new roslib_1["default"].Topic({
        ros: ros,
        name: '/robot_pose',
    ...
    if (withOrientation === false) {
        ...
        this.rootObject.addEventListener('dblclick', function (event) {
            ...
            var pose = new roslib_1["default"].Pose({
                position: new roslib_1["default"].Vector3(coords)
            });
            // send the goal
            sendGoal(pose);
        });
        ...
        var mouseEventHandler = function (event, mouseState) {
            if (mouseState === 'down') {
                ...
                positionVec3 = new roslib_1["default"].Vector3(position);
                mouseDown = true;
            }
                ...
                if (mouseDown === true) {
                    ...
                    var currentPosVec3 = new roslib_1["default"].Vector3(currentPos);
                    orientationMarker = new ros2d_1["default"].NavigationArrow({
                        size: 25,
                        strokeSize: 1,
                ...
                var goalPosVec3 = new roslib_1["default"].Vector3(goalPos);
                ...
                var orientation = new roslib_1["default"].Quaternion({ x: 0, y: 0, z: qz, w: qw });
                var pose = new roslib_1["default"].Pose({
...
NAV2D.OccupancyGridClientNav = function (options) {
    ...
    this.navigator = null;
    // setup a client to get the map
    var client = new ros2d_1["default"].OccupancyGridClient({
        ros: this.ros,
        rootObject: this.rootObject,
